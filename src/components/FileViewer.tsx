...
export default function FileViewer({ fileName, content, onClose }: FileViewerProps) {
  ...
  return (
    <>
      ...
      {/* Panel */}
      <div className="fixed right-0 top-0 bottom-0 w-full max-w-lg bg-[#0d1520] border-l border-[#1e293b] z-50 slide-in-right flex flex-col">
        {/* Header */}
        <div className="flex items-center gap-3 px-5 py-4 border-b border-[#1e293b] shrink-0">
          <div className="w-8 h-8 rounded-lg border border-[#1e293b] bg-blue-500/10 flex items-center justify-center">
          ...
          <button
            onClick={onClose}
            className="ml-auto w-8 h-8 rounded-lg border border-[#1e293b] hover:border-[#2d3f5a] hover:bg-[#1a2235] flex items-center justify-center text-[#475569] hover:text-[#94a3b8] transition-all"
          >
        ...
        <div className="flex-1 overflow-auto p-5">
          {content ? (
            ...
            <div className="flex flex-col items-center justify-center h-full gap-3 text-center">
              <div className="w-12 h-12 rounded-full border border-[#1e293b] bg-[#111827] flex items-center justify-center">
              ...
              <div>
                <p className="text-sm text-[#475569] mb-1">File contents not provided</p>
