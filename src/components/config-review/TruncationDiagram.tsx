  ...
  return (
    <div className="mt-2 mb-1">
      ...
      <div className="flex h-6 rounded-md overflow-hidden border border-[#1e293b]">
        {/* Head — visible */}
        <div
          className="bg-blue-500/30 flex items-center justify-center"
          style={{ width: `${headPct}%` }}
        >
        ...
        >
          <span className="text-[9px] font-mono text-red-400 truncate px-1">
      ...
      {/* Labels */}
      <div className="flex justify-between mt-1 text-[9px] font-mono text-[#475569]">
        <span>Char 1</span>
