      ...
      <div className="max-w-2xl mx-auto">
        ...
        >
          ...
          <ul className="space-y-5 mb-8">
            {[
              {
                q: 'Why does my agent forget instructions?',
                a: 'See exactly which rules survive long conversations and which ones vanish silently.',
              },
              {
                q: 'Where are my tokens going?',
                a: 'Your config files get re-injected every message. We\u2019ll show you the per-message cost and where to cut.',
              },
              {
                q: 'Why do my subagents behave differently?',
                a: 'Three of your eight config files are invisible to subagents. We\u2019ll show you which ones.',
              },
              {
                q: 'Which files are starving which?',
                a: 'OpenClaw loads your files in a fixed order. The last file gets whatever budget is left. We\u2019ll show the cascade.',
              },
            ].map(({ q, a }) => (
